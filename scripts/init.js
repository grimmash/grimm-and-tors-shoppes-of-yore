(() => {
  const adventureName = 'Grimm and Tor\'s Shoppes of Yore';
  const moduleName = 'grimm-and-tors-shoppes-of-yore';
   ...
   */
  const welcomeJournal = 'Welcome to the Shoppes';
  /**
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = ["grimm-and-tors-shoppes-of-yore.shoppes-actors"];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = ["grimm-and-tors-shoppes-of-yore.shoppes-journals"];
  /**
   ...
   *   const macroPacks = [];
   */
  const macroPacks = ["grimm-and-tors-shoppes-of-yore.shopes-macros"];
  /**
   ...
   *   const playlistPacks = [];
   */
  const playlistPacks = ["grimm-and-tors-shoppes-of-yore.shops-playlists"];
  /**
   ...
   */
  const additionalModulePacks = ["grimm-and-tors-shoppes-of-yore","dnd5e"];
